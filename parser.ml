...
# 148 "parser.ml"
             in
            _menhir_goto_factor _menhir_env _menhir_stack _menhir_s _v) : 'freshtv78)) : 'freshtv80)
        | SUB ->
...
# 282 "parser.ml"
    ...
    | _ ->
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        _menhir_env._menhir_shifted <- (-1);
        _menhir_errorcase _menhir_env (Obj.magic _menhir_stack) MenhirState8) : 'freshtv72)
...
# 473 "parser.ml"
             in
            _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v) : 'freshtv64)
        | _ ->
            assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
            _menhir_env._menhir_shifted <- (-1);
            let (_menhir_env : _menhir_env) = _menhir_env in
...
and _menhir_goto_factor : _menhir_env -> 'ttv_tail -> _menhir_state -> (
# 21 "parser.mly"
      (ArithExpr.arith_expr)
# 497 "parser.ml"
) -> 'ttv_return =
...
# 534 "parser.ml"
         in
        _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v) : 'freshtv32)) : 'freshtv34)
    | MenhirState6 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
...
# 570 "parser.ml"
         in
        _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v) : 'freshtv36)) : 'freshtv38)
    | MenhirState8 ->
        let (_menhir_env : _menhir_env) = _menhir_env in
...
# 606 "parser.ml"
         in
        _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v) : 'freshtv40)) : 'freshtv42)
...
# 633 "parser.ml"
         in
        _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v) : 'freshtv44)) : 'freshtv46)
...
# 746 "parser.ml"
     in
    _menhir_goto_factor _menhir_env _menhir_stack _menhir_s _v) : 'freshtv14)
